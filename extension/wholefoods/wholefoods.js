...
// // for (x = 0; x < existing_images.length; x++) {
// //   if (x >= new_images.length) {
// //     var index = x % new_images.length;
// //     existing_images[x].setAttribute("src", new_images[index]);
// //   } 
// //   else {
// //     existing_images[x].setAttribute("src", new_images[x]);
// //   }
// // }
...
//     links[i].style.backgroundColor = "Lavender";
// }
// "Lavender"
